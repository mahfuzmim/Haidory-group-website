...
import about from "../../assets/images/kanizabout.png";
...
import styles from "./kaniz.module.css";
import kanizimg from "../../assets/images/Kaniz.jpeg";
...
const Kaniz = () => {
  ...
  return (
    <Common>
      <section className={styles.kanizbannersection}>
        <div className=""></div>
      </section>
          ...
          <Container>
            <Row>
              <Col md={6} className="mt-4 mb-4" data-aos="fade-left">
                <img className="image-logo-sisters" src={kanizimg} alt="logo" />
              </Col>
              <Col md={6} className="mt-5 pt-5 mb-4" data-aos="fade-right">
                <h2>About KANIZ TRAVELS</h2>
                <p style={{ fontSize: "1.3em" }}>
                  {" "}
                  A sister concern of haidroygroup. It has been the leading Hajj
                  and Umrah travel guide . We assist our client with utmost
                  sincerity to make the activities of Hajj and Umrah easy.It
                  received IATA accrediation and received it approval from Biman
                  Bangladesh Airlines Ltd..Bangladesh Government approved Kaniz
                  Travels as a Hajj agent, holding the Hajj license No. 0077 and
                  Umrah license No. 042
                </p>
              </Col>
            </Row>
          </Container>
        ...
        <Container>
          <Row>
            <Col md={6} className="mt-0 pt-5 mb-0" data-aos="fade-right">
              <h2>Why Choose KANIZ TRAVELS?</h2>
              <p> </p>
      ...
      <section className="all-company-feature mb-0 all-services mt-service com-miss-vis">
        <Container>
          <Row>
